...
public final class DeltaT {
    ...
    public static double estimate(final double year) {
        ...
        if (year < -500) {
            ...
            deltaT = polynomial(u, 1574.2, -556.01, 71.23472, 0.319781, -0.8503463, -0.005050998, 0.0083572073);
        } else if (year < 1700) {
            double t = year - 1600;
            ...
            double t = year - 1800;
            deltaT = polynomial(t, 13.72, -0.332447, 0.0068612, 0.0041116, -0.00037436, 0.0000121272, -0.0000001699, 0.000000000875);
        } else if (year < 1900) {
            double t = year - 1860;
